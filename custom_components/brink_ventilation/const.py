...
CONNECTION_STATUS_AUTH_ERROR = "authentication_error"
CONNECTION_STATUS_SERVER_ERROR = "server_error"
CONNECTION_STATUS_TIMEOUT = "timeout"
CONNECTION_STATUS_CONNECTION_ERROR = "connection_error"
CONNECTION_STATUS_NO_INTERNET = "no_internet"
CONNECTION_STATUS_UNKNOWN_ERROR = "unknown_error"
...
# URL used for internet connectivity check (lightweight 204 response)
